...
class CaracteristicasController
{
    ...
    public function updateStatus(){
        ...
        $response = $this->model->update($_POST["id"],$_POST["status"],);
        echo json_encode(["success"=>true, "message"=>"registro {$_POST["id"]} actualizado"]);
    }

    public function deleteGce(){
    
        $response = $this->model->deleteComputer($_POST["id"]);
        echo json_encode(["success"=>true, "message"=>"registro {$_POST["id"]} eliminado"]);
    }


    public function updateGce(){
        $response = $this->model->updateComputer($_POST);
        echo json_encode(["success"=>true, "message"=>"registro {$_POST["id"]} actualizado"]);
    }
